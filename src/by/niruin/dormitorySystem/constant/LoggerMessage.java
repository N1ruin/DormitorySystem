...
public class LoggerMessage {
    public static final String START_SCANNING_DIRECTORY_LOG = "Start scanning directory %s";
    ...
    public static final String ENTERED_INVALID_VALUE_LOG = "User entered an invalid value: %s";

    public static final String STARTED_MENU_CREATED_LOG = "Started menu created";

    public static final String USER_NAVIGATE_TO_MENU_LOG = "User navigate to menu %s";

    public static final String APP_STARTED_LOG = "Application started";

    public static final String APP_ERROR_LOG = "Application error";

    public static final String SAVING_DATA_LOG = "Saving data...";

    public static final String APP_EXIT_LOG = "Application exit...";

    public static final String START_LOADING_DATA_LOG = "Start loading application data";
    ...
    public static final String ROOM_CREATED_FAIL_LOG = "Room with number %d not created";

    public static final String ROOM_DELETED_SUCCESSFUL_LOG = "Room with number %d deleted";

    public static final String ROOM_DELETED_FAIL_LOG = "Room with number %d not deleted";

    public static final String ROOM_UPDATED_SUCCESSFUL_LOG = "Room with number %d updated";

    public static final String ROOM_UPDATED_FAIL_LOG = "Room with number %d not updated";

    public static final String ROOM_INFO_RECEIVED_SUCCESS_LOG = "Room info received";

    public static final String ROOM_INFO_RECEIVED_FAIL_LOG = "Room info not received";

    public static final String DORMITORY_INHABITED_STUDENTS_INFO_RECEIVED_SUCCESS_LOG = "Information about students without a room received";

    public static final String DORMITORY_INHABITED_STUDENTS_INFO_RECEIVED_FAIL_LOG = "Information about students without a room not received";

    public static final String USER_REGISTRATION_SUCCESS_LOG = "User %s registration success";

    public static final String USER_REGISTRATION_FAIL_LOG = "User %s registration failed";
