...
@Component
public class GetUserInfoFormHandler {
    private final PrintService printService;
    private final FormHandler formHandler;
    private final UserInputValidationService userInputValidationService;
    private String login;

    public GetUserInfoFormHandler(PrintService printService, FormHandler formHandler, UserInputValidationService userInputValidationService) {
        this.printService = printService;
        this.formHandler = formHandler;
        this.userInputValidationService = userInputValidationService;
    }

    public GetUserInfoFormHandler handleLogin() {
